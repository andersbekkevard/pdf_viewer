...
#
# Conversion now uses a native arm64 pdf2htmlEX binary (no Docker). The
# underlying script fails fast with an install hint if the binary is missing,
# surfaced via macOS notification.
